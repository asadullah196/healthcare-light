...
final class Bootstrap {
    ...
    public function js_css_admin() {
        ...
        if( in_array($screen_id, $allowed_screen_ids) ){
            ...
            wp_enqueue_style( 'admin-datetime', \Wpeventin::assets_url() . 'css/jquery.datetimepicker.min.css', [], \Wpeventin::version(), 'all' );
            ...
            wp_enqueue_script( 'admin-datetime', \Wpeventin::assets_url() . 'js/jquery.datetimepicker.full.min.js', ['jquery'], \Wpeventin::version(), true );
            // locallize data
