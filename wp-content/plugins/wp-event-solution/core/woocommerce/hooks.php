...
class Hooks {
    ...
    public function update_event_stock_on_order_status_update( $order_id, $old_order_status, $new_order_status ){
        ...
        if( in_array($new_order_status, $decrease_states) && ( !in_array($old_order_status, $decrease_states) && !in_array($old_order_status, $no_action_state) ) ){
    ...
    public function add_cart_item_data( $cart_item_data, $product_id, $variation_id ) {
        ...
        $cart_item_data['event_id'] = $post_arr['add-to-cart'];
